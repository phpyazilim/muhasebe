...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Diller /</span> Dil Güncelle - {{ $lang->baslik  }}  </h4>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body my-3">
                            <form  action="{{ route('admin.lang.update',['id' => $lang->id ]) }}" id="formAccountSettings" method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="card-body" style="padding:38px">
                                            ...
                                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                ...
                                                <div class="button-wrapper">
                                                    ...
                                                    <input  type="hidden" name="old_ustlogo"  value="{{$lang->icon}}"  />
