...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getMenuByMenuId($id, "tr")->baslik }}  /</span> İçerik Ekle  </h4>


            <div class="card">

                <div class="card-body my-3">
                    <form  action="{{ route('admin.icerik.save',['id' => $id ]) }}"  id="formAccountSettings" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="nav-align-top mb-4">
                                    ...
                                    <div class="col-xl-12">
                                            ...
                                            <div id="tab{{ $dilb->kod }}"   class="tabcontent" style="{{ $dilb->kod == "tr" ? 'display: block;' : 'display: none;' }} " >
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select name="category" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                                        ...
                                                        <option value="{{ $menu->parentId }}">{{ $menu->baslik }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <p> <textarea name="kisaaciklama_{{ $dilb->kod }}" class="form-control" placeholder="Kısa Açıklama"></textarea>
                                            </p>
                                        </div>
                                                    @endif
                                        ...
                                        <div>
                                            ...
                                            <p> <textarea name="aciklama_{{ $dilb->kod }}" class="summernote" style="  "></textarea>
                                            </p>
                                        </div>
                                           @endif
                                ...
                                <div class="card-body" style="padding:38px">
                                    ...
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <input  type="hidden" name="old_dosya1"  value=""  />
                                ...
                                <div class="card-body" style="padding:38px">
                                    ...
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <input  type="hidden" name="old_dosya2"  value=""  />
                                ...
                                <div class="card-body" style="padding:38px">
                                    ...
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        ...
                                        <div class="button-wrapper">
                                            ...
                                            <input  type="hidden" name="old_dosya3"  value=""  />
