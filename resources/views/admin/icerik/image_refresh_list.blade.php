...
<table class="table table-bordered table-striped table-hover pictures_list">
    ...
    <tbody class="table-border-bottom-0 sortable  " data-url="{{route('admin.icerik.imageRankSetter')}}" >
    ...
    <tr id="ord-{{$image->id}} " >
        ...
        <td class="   text-center  ">
            ...
            <label class="switch">
                <input
                    data-url="{{ route('admin.icerik.imageIsActiveSetter', ['id' => $image->id,'parentId' => $image->parentId,'parent' => 'icerik' ]) }}"
        ...
        <td class="  text-center">
            ...
            <label class="switch">
                <input
                    data-url="{{ route('admin.icerik.imageIsCoverSetter', ['id' => $image->id,'parentId' => $image->parentId,] ) }}"
        ...
        <td class="  text-center">
            ...
            <form id="removeForm" name="kayitSil" method="post"  action="{{ route('admin.icerik.imageDelete', ['id' => $image->id] ) }}">
                @csrf
                @method('delete')
