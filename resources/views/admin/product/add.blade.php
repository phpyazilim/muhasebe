...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">  Ürünler /</span> Ürün Ekle  </h4>


            <div class="card">

                <div class="card-body my-3">
                    <form  action="{{ route('admin.product.save' ) }}"  id="formAccountSettings" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="markaId" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                            ...
                                            @foreach(getAllMarkalar() as $marka)
                                                <option value="{{ $marka->id }}">{{ $marka->baslik }}</option>
                                            @endforeach
