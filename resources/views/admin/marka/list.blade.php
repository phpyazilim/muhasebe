...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4 class="fw-bold py-3 mb-4 text-left" ><span class="text-muted fw-light">Markalar /</span> Tüm Markalar</h4>
                </div>
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <table class="table table-striped">
                                                ...
                                                <tr   id="ord-{{ $marka->id }}"  data-title="Sıralama" data-intro="Bu satırı sürükleyip sıralamayı değiştirebilirsiniz" data-step="3">
                                                    <td> <strong>{{ $marka->baslik }}</strong></td>
                                                    ...
                                                    <td data-title="Aktif/Pasif" data-intro="Burayı tıklayarak durumu aktif pasif hale getirebilirsiniz." data-step="4" >
                                                        <label class="switch">
                                                            <input
                                                                data-url="{{ route('admin.marka.isActiveSetter', $marka->id) }}"
                                                                type="checkbox"
                                                                class="checkbox isActive"
                                                                {{ $marka->isActive == 1 ? 'checked' : '' }}
                                                            >
                                                    ...
                                                    <td>
                                                        ...
                                                        <div style="display: flex; align-items: center;" >
                                                            <form id="removeForm" name="kayitSil" method="post"  action="{{ route('admin.marka.remove', ['id' => $marka->id ]) }}">
                                                                @csrf
                                                                @method('delete')
                                                            ...
                                                            <a href="{{ route('admin.marka.update_form', ['id' => $marka->id ]) }}" class=" mx-2 btn rounded-pill btn-icon btn-info " data-title="Güncelle" data-intro="Güncelleme işlemlerini buradan yapabilirsiniz" data-step="6">
