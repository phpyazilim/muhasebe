...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">  Kategoriler /</span> Kategori Ekle  </h4>


            <div class="card">

                <div class="card-body my-3">
                    <form  action="{{ route('admin.categories.save' ) }}"  id="formAccountSettings" method="POST" enctype="multipart/form-data" >
