...
@section('getTitle') 
@if(isset($sehir) && isset($kelime))  {{ $sehir }} - {{ $kelime }}  - @endif

@endsection

@section('getDescription')  @if(isset($sehir) && isset($kelime))  {{ $sehir }} - {{ $kelime }}  - @endif @endsection
...
@section('content') 
       ...
       @include('frontend.layouts.anasayfaurunler')
...
@endif
                        ...
                        <div class="col-lg-7 offset-xxl-1 position-relative md-mb-30px sm-mb-15"
                            ...
                            <img src="{{asset('uploads/teknolojik_tarim.png')}}" class="position-relative z-index-9 top-40px" alt="">
...
@endif
                            <div class="border-radius-6px h-450px md-h-350px sm-h-400px d-flex flex-wrap align-items-center justify-content-center overflow-hidden cover-background box-shadow-quadruple-large pt-15" style="background-image: url('{{asset("uploads/videobgmb.png")}}')">
                                ...
                                <div class="row justify-content-center m-0">
                                    ...
                                    <div class="col-md-2 position-relative z-index-1 text-center sm-mb-20px">
                                        <a href="https://www.youtube.com/watch?v=s-D0mMI2MoY" class="position-relative d-inline-block text-center border border-2 border-color-white rounded-circle video-icon-box video-icon-large popup-youtube">
                                            <span>
